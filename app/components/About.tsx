...
import { BriefcaseBusiness, CheckCircle2, ChevronDown, ChevronUp, Eye, HeartHandshake, Sparkles } from 'lucide-react';
...
export default function About() {
  ...
  return (
    <section id="about" className="section bg-gradient-to-t from-background-alt to-background pb-5">
      <div className="text-center container-tight">
        <h2 className="text-5xl text-text-primary text-left mb-5">
          About Us
        </h2>
        ...
        <div className="grid gap-8 md:grid-cols-1">
          <Card className="bg-background">
            ...
            <CardContent className="text-justify">
              Double Helix is a senior, lean engineering team based in Latvia. We start with discovery to map your
              bottlenecks and risks, then deliver right‑sized software, integrations, and automation. We prioritize
          ...
          <Card className="bg-background">
            ...
            <CardContent className="text-justify">
              <div><span className="text-primary">Mission: </span>We help businesses transform complexity into clarity
                through tailored IT solutions—guided by technical excellence, empathy, and strategic thinking.
              </div>
              <div><span className="text-primary">Vision: </span>We create a healthier, safer & better organized world
                by solving IT challenges for companies making a positive impact.
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <ul className="space-y-2">
                {[
                  ...
                  <li key={v} className="flex gap-2"><CheckCircle2
                    className="h-4 w-4 text-accent-green flex-shrink-0 mt-1"/>{v}</li>
                ))}
              </ul>
            </CardContent>
          </Card>
      ...
      <h3 className="text-3xl md:text-4xl text-text-primary my-16 text-center">Founders</h3>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8 container-tight">
