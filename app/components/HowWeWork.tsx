...
import { Activity, CheckCircle2, GitBranch, Server, ShieldCheck, Users } from 'lucide-react';
...
export default function HowWeWork() {
  ...
  return (
    <section id="how-we-work" className="section bg-background container-tight">
      <div className="text-center mb-20">
        <h2 className="text-5xl text-center text-text-primary mb-5">
          How we work
        </h2>
        <p className="text-text-secondary max-w-2xl mx-auto">
          We keep the process simple and transparent. Here's how engagements typically progress—from first conversations
